...
def get_assistant_response(messages):
    ...
    try:
        ...
        if "404" in error_msg and "not found" in error_msg:
            ...
            return "Sorry, your Gemini API key appears to be invalid. Please check your API key in the .env file."
        else:
...
if not GEMINI_API_KEY or GEMINI_API_KEY == "your-api-key-here":
    ...
    st.info("Add your API key in the `.env` file like this: `GEMINI_API_KEY=AIzaSyBZqn0BZyxJFhsjcKTDPcBFybm9ELjkIpw`")
    st.stop()
...
if prompt := st.chat_input("What's on your mind?"):
    ...
    with st.chat_message("assistant"):
        ...
        full_response = get_assistant_response(st.session_state.messages)
